...
export default function GroceryPage() {
    ...
    // Create-on-the-fly ingredient from the grocery view
    ...
    const categories = Object.keys(groceryMap).sort();
    const totalItems = categories.reduce((sum, cat) => sum + groceryMap[cat].length, 0);
    ...
    return (
        <div className="max-w-lg mx-auto px-4 pt-4 pb-4 animate-fade-in">
            ...
            <div className="flex items-center justify-between mb-5">
                <h1 className="text-xl font-extrabold text-white">Grocery List</h1>
                <button
            ...
            {totalItems > 0 && (
                <div className="mb-4 bg-slate-800 rounded-2xl p-4">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-xs font-semibold text-slate-400">Shopping Progress</span>
            ...
            {isLoading ? (
                ...
                <div className="text-center py-16">
                    ...
                    <p className="text-xs text-slate-500 mt-1">Assign recipes to your planner to generate the list.</p>
                </div>
            ) : (
